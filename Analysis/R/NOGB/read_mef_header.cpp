...
namespace Rcpp {
 template <>
 SEXP wrap(const MEF_HEADER_INFO& x) {
   std::vector<std::string> names;
   std::vector<SEXP> elements(47);
   // do something with the elements and names
   names.push_back("institution");
   elements[0] = Rcpp::wrap( x.institution );
   names.push_back("unencrypted_text_field");
   elements[1] = Rcpp::wrap( x.unencrypted_text_field );
   names.push_back("encryption_algorithm");
   elements[2] = Rcpp::wrap( x.encryption_algorithm );
   names.push_back("subject_encryption_used");
   elements[3] = Rcpp::wrap( x.subject_encryption_used );
   names.push_back("session_encryption_used");
   elements[4] = Rcpp::wrap( x.session_encryption_used );
   names.push_back("data_encryption_used");
   elements[5] = Rcpp::wrap( x.data_encryption_used );
   names.push_back("byte_order_code");
   elements[6] = Rcpp::wrap( x.byte_order_code );
   names.push_back("header_version_major");
   elements[7] = Rcpp::wrap( x.header_version_major );
   names.push_back("header_version_minor");
   elements[8] = Rcpp::wrap( x.header_version_minor );
   names.push_back("session_unique_ID");
   std::ostringstream buf;
   buf << (int)x.session_unique_ID[0];
   for (int j=1; j<8; j++) buf << " " << (int)( x.session_unique_ID[j] );
   elements[9] = Rcpp::wrap( buf.str() );
   names.push_back("header_length");
   elements[10] = Rcpp::wrap( x.header_length );
   names.push_back("subject_first_name");
   elements[11] = Rcpp::wrap( x.subject_first_name );
   names.push_back("subject_second_name");
   elements[12] = Rcpp::wrap( x.subject_second_name );
   names.push_back("subject_third_name");
   elements[13] = Rcpp::wrap( x.subject_third_name );
   names.push_back("subject_id");
   elements[14] = Rcpp::wrap( x.subject_id );
   names.push_back("session_password");
   elements[15] = Rcpp::wrap( x.session_password );
   names.push_back("subject_validation_field");
   elements[16] = Rcpp::wrap( x.subject_validation_field );
   names.push_back("session_validation_field");
   elements[17] = Rcpp::wrap( x.session_validation_field );
   names.push_back("protected_region");
   elements[18] = Rcpp::wrap( x.protected_region );
   names.push_back("number_of_samples");
   elements[19] = Rcpp::wrap( x.number_of_samples );
   names.push_back("channel_name");
   elements[20] = Rcpp::wrap( x.channel_name );
   names.push_back("recording_start_time");
   elements[21] = Rcpp::wrap( x.recording_start_time );
   names.push_back("recording_end_time");
   elements[22] = Rcpp::wrap( x.recording_end_time );
   names.push_back("sampling_frequency");
   elements[23] = Rcpp::wrap( x.sampling_frequency );
   names.push_back("low_frequency_filter_setting");
   elements[24] = Rcpp::wrap( x.low_frequency_filter_setting );
   names.push_back("high_frequency_filter_setting");
   elements[25] = Rcpp::wrap( x.high_frequency_filter_setting );
   names.push_back("notch_filter_frequency");
   elements[26] = Rcpp::wrap( x.notch_filter_frequency );
   names.push_back("voltage_conversion_factor");
   elements[27] = Rcpp::wrap( x.voltage_conversion_factor );
   names.push_back("acquisition_system");
   elements[28] = Rcpp::wrap( x.acquisition_system );
   names.push_back("channel_comments");
   elements[29] = Rcpp::wrap( x.channel_comments );
   names.push_back("study_comments");
   elements[30] = Rcpp::wrap( x.study_comments );
   names.push_back("physical_channel_number");
   elements[31] = Rcpp::wrap( x.physical_channel_number );
   names.push_back("compression_algorithm");
   elements[32] = Rcpp::wrap( x.compression_algorithm );
   names.push_back("maximum_compressed_block_size");
   elements[33] = Rcpp::wrap( x.maximum_compressed_block_size );
   names.push_back("maximum_block_length");
   elements[34] = Rcpp::wrap( x.maximum_block_length );
   names.push_back("block_interval");
   elements[35] = Rcpp::wrap( x.block_interval );
   names.push_back("maximum_data_value");
   elements[36] = Rcpp::wrap( x.maximum_data_value );
   names.push_back("minimum_data_value");
   elements[37] = Rcpp::wrap( x.minimum_data_value );
   names.push_back("index_data_offset");
   elements[38] = Rcpp::wrap( x.index_data_offset );
   names.push_back("number_of_index_entries");
   elements[39] = Rcpp::wrap( x.number_of_index_entries );
   names.push_back("block_header_length");
   elements[40] = Rcpp::wrap( x.block_header_length );
   names.push_back("GMT_offset");
   elements[41] = Rcpp::wrap( x.GMT_offset );
   names.push_back("discontinuity_data_offset");
   elements[42] = Rcpp::wrap( x.discontinuity_data_offset );
   names.push_back("number_of_discontinuity_entries");
   elements[43] = Rcpp::wrap( x.number_of_discontinuity_entries );
   names.push_back("file_unique_ID");
   buf.str("");
   buf.clear();
   buf << (int)x.file_unique_ID[0];
   for (int j=1; j<FILE_UNIQUE_ID_LENGTH; j++) buf << " " << (int)( x.file_unique_ID[j] );
   elements[44] = Rcpp::wrap( buf.str() );
   names.push_back("anonymized_subject_name");
   elements[45] = Rcpp::wrap( x.anonymized_subject_name );
   names.push_back("header_crc");
   elements[46] = Rcpp::wrap( x.header_crc );
/*
   names.push_back("file_index");
   elements[47] = Rcpp::wrap( x.file_index );
   names.push_back("discontinuity_data");
   elements[48] = Rcpp::wrap( x.discontinuity_data );
*/   
...
namespace Rcpp {
  template <>
  SEXP wrap(const MEF_HEADER_INFO& x) {
    double header_length = x.header_length;
    double number_of_samples = x.number_of_samples;
    double recording_start_time = x.recording_start_time;
    double recording_end_time = x.recording_end_time;
    double sampling_frequency = x.sampling_frequency;
    double low_frequency_filter_setting = x.low_frequency_filter_setting;
    double high_frequency_filter_setting = x.high_frequency_filter_setting;
    return Rcpp::wrap(Rcpp::DataFrame::create(Rcpp::Named("institution") = x.institution,
                                              Rcpp::Named("unencrypted_text_field") = x.unencrypted_text_field,
                                              Rcpp::Named("encryption_algorithm") = x.encryption_algorithm,
                                              Rcpp::Named("subject_encryption_used") = x.subject_encryption_used,
                                              Rcpp::Named("session_encryption_used") = x.session_encryption_used,
                                              Rcpp::Named("data_encryption_used") = x.data_encryption_used,
                                              Rcpp::Named("byte_order_code") = x.byte_order_code,
                                              Rcpp::Named("header_version_major") = x.header_version_major,
                                              Rcpp::Named("header_version_minor") = x.header_version_minor,
                                              Rcpp::Named("header_length") = header_length,
                                              Rcpp::Named("subject_first_name") = x.subject_first_name,
                                              Rcpp::Named("subject_second_name") = x.subject_second_name,
                                              Rcpp::Named("subject_third_name") = x.subject_third_name,
                                              Rcpp::Named("subject_id") = x.subject_id,
                                              Rcpp::Named("session_password") = x.session_password,
                                              Rcpp::Named("subject_validation_field") = x.subject_validation_field,
                                              Rcpp::Named("session_validation_field") = x.session_validation_field,
                                              Rcpp::Named("protected_region") = x.protected_region,
                                              Rcpp::Named("number_of_samples") = number_of_samples,
                                              Rcpp::Named("channel_name") = x.channel_name,
                                              Rcpp::Named("channel_name2") = x.channel_name
//                                              Rcpp::Named("recording_start_time") = recording_start_time,
//                                              Rcpp::Named("recording_end_time") = recording_end_time
//                                              Rcpp::Named("sampling_frequency") = sampling_frequency
//                                              Rcpp::Named("low_frequency_filter_setting") = low_frequency_filter_setting,
//                                              Rcpp::Named("high_frequency_filter_setting") = high_frequency_filter_setting
    ));
  };
}
*/
...
// [[Rcpp::export]]
MEF_HEADER_INFO read_mef_header(Rcpp::StringVector strings) {
//Rcpp::StringVector read_mef_header(Rcpp::StringVector strings) {
